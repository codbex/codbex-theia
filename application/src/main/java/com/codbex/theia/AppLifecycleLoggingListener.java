...
class AppLifecycleLoggingListener implements ApplicationListener<ApplicationEvent>, DisposableBean {
    ...
    public void onApplicationEvent(ApplicationEvent event) {
        ...
        if (event instanceof ApplicationReadyEvent) {
            ...
            log("Start time: [{}] milliseconds. Init time: [{}] milliseconds", (currentTime - TheiaApplication.getStartedAt()),
    ...
    public void destroy() {
        ...
        log("Application started at [{}] and has been running for [{}] milliseconds", TheiaApplication.getStartedAt(),
                (System.currentTimeMillis() - TheiaApplication.getStartedAt()));
    }
}
